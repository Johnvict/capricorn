...
class CreateOldEpinTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('old_epin_transactions', function (Blueprint $table) {
			$table->id();
    ...
    {
        Schema::dropIfExists('old_epin_transactions');
    }
}
