...
class CreateOldDataTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('old_data_transactions', function (Blueprint $table) {
			$table->id();
    ...
    {
        Schema::dropIfExists('old_data_transactions');
    }
}
